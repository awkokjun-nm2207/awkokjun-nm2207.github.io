...
<head>
  ...
  <title>Tiktok Livestream E-commerce Sales</title>
...
<!------------------------------------------------------------------------ Button-------------------------------------------------------------------------------------->
<div id="nav-bar">
    <a href="/Users/kj/Desktop/NUS/Y2S2/NM2207/Final Project/NM2207_FINAL PROJECT_v2.pdf" target="_blank">
     <button> Project Storyboard & Diary Entries
    </button>
  </a>
  
  <a href="https://seller-sg.tiktok.com/account/register" target="_blank">
  <button> Tiktok Shop
  </button>
</a>
  ...
  <button> Data Visualisation
  </button>
</a>

  <div id="empty-space"></div> 
<!--------------------------------------------------------------------------------------Heading Text------------------------------------------------------------------------>
<div id="heading-title-text">
    <h1>Tiktok Livestream E-commerce Sales</h1>
</div>

<div id="intro-content">

<img id=tiktok-img src="Tiktokshop.png" alt="A description of the image" >
<div id="empty-space"></div> 

<div>
  
<h2>Introduction</h2>
With the rise of social media, Tiktok has become a platform for people to share their lives and interact with others. 
  One of the most popular social media platforms in the world, Tiktok is a platform where people can share their videos and interact with others. 
  There are many ways to make money on Tiktok. One of the ways is to sell products on Tiktok Shop. 
  However, with the rise of livestream e-commerce, Tiktok is now considering if it should follow the footsteps of 
  its parent company ByteDance in establishing a market presence for Livestream E-commerce in Singapore.
  </div>

  <div id="empty-space"></div> 

  <div id="text-below-intro">
  Due to limitations to theexisting pool of available data, live e-commerce sales will be used to approximate the demand for tiktokshop's livestream e-commerce sales.
</div>

<div id="empty-space"></div>

<!----------------------------------------------------------Data visualisation 1: bar chart------------------------------------------------------------------------>
<a href="" target="_blank">
  <button> Data Visualisation
  </button>
</a>
...
<div class="black-bg-white-text">
    ...
    <a href="https://www.statista.com/statistics/1129543/china-e-commerce-market-gross-merchandise-volume/">Source: Statista</a>
  <div>Evidently, Livestream E-commerce is a huge trillion yuan market in China. It reached its highest in 2020 at 37.21 trillion yuan. Hence, Singapore-based Tiktok should emulate after its parent company Bytedance's success in China.</div>
  </div>
...
<!------------------------------------------------------------------------Data visualisation 2: pie chart---------------------------------------------------------->
  <div class="black-bg-white-text">
    <div id="empty-space"></div> 
    <canvas id="myPieChart"></canvas>
    <a href="https://www-statista-com.libproxy1.nus.edu.sg/statistics/1271637/sea-live-commerce-awareness-and-usage-by-country/?locale=en">Source: Statista</a>
  </div>
  
  <div>As shown, Vietnam has the highest percentage of respondents (70%) who bought products from live e-commerce platforms. On the other hand, Singapore has the lowest (21%). This shows that Singapore has much room for growth in the live e-commerce market, in converting viewers into buyers.</div>

<div id="empty-space"></div>
<div id="border"></div>

<!--------------------------------------------Asked ChatGPT how to create a polar chart using Chart.js which was not taught in class-------------------------------------------->
<!-----------------------------------------------------------------------data visualisation 3: polar chart---------------------------------------------------------->
  <div class="black-bg-white-text">
    <canvas id="myPolarChart"></canvas>
    <a href="https://www-statista-com.libproxy1.nus.edu.sg/statistics/1271637/sea-live-commerce-awareness-and-usage-by-country/?locale=en">Source: Statista</a>
  </div>
  <div> Vietnam and Singapore has the highest growth prospects for livestream e-commerce in the ASEAN region.</div>
  <div id="empty-space"></div> 
  <div id="border"></div>
...
<div id="empty-space"></div>
  ...
  <!---------------------------------Data visualisation 4: used chatgpt to ask how to create a horizontal bar chart using chart.js------------------------------------>
  <div>
  <canvas id="myHorizontalBarChart"></canvas>
  <a href="https://www-statista-com.libproxy1.nus.edu.sg/statistics/1346506/companies-livestreaming-use-objectives-worldwide/">Source: Statista</a>
  <div id="empty-space"></div> 
<div>To persuade its potential stakeholders, the Business Development team at Tiktok should consider citing improved shopping experience and customer engagement/feedback. As seen from the bar chart above, they are listed as the top 2 reasons. This translates to higher revenue and profit margins.</div>
</div>
...
<div id="border"></div>
<h2>Conclusion</h2>
<div>With the above analysis, it is clear that there is huge potential revenue and profit for live commerce. China's live commerce is worth over 73.21 trillion and is expected to grow at an exponential rate. Vietnam is an emerging market to enter for Tiktok, apart from Singapore. Improved shopping experience and customer engagement are reasons to convince potential merchants to ride on live commerce as their potential main driver of sales. Hence, Tiktok should consider adopting livestream e-commerce as its strategic focus, instead of Tiktok Shop as the main source of profit.  </div>
<div id="empty-space"></div> 

<!--------------------------------------------------------------Used UI Verse for the Future of E-commerce----------------------------------------------------------->
<div class="radio-input">
  ...
  <div class="radio_item">
    <input type="radio" id="value-1" name="value-radio" value="Livestream" class="radio">
    ...
    <label for="value-1" class="pointer">Livestream</label>
  </div>


  <div class="radio_item">
    <input type="radio" id="value-2" name="value-radio" value="Is the Future of" class="radio">
    ...
    <label for="value-2" class="pointer">Is the Future of</label>
  </div>



  <div class="radio_item">
    <input type="radio" id="value-3" name="value-radio" value="E-commerce" class="radio">
    ...
    <label for="value-3" class="pointer">E-commerce</label>
  </div>
...
<div id="bottom-info-bar">
  <div id="about-us">
    <div id="empty-space"></div> 
      <h2>About Us</h2>
      <p>
        We are a dedicated team of data analysts and developers focused on providing insights into the e-commerce industry, specifically the live streaming sales on platforms like Tiktok. Our mission is to help businesses make informed decisions using our data visualizations and in-depth analysis.
      </p>
    </div>
    ...
    <div id="contact-us">
      ...
      <p>
        Email: info@tiktoklivestreamsales.com
        <br>
        Phone: +65 6343 4470
      </p>
    </div>
...
<!--------------------------------------------------------------------Footer---------------------------------------------------------------------------------------->
<div>
        <p>&copy; 2023 Tiktok Livestream E-commerce Sales. All rights reserved.</p>
      </div>
